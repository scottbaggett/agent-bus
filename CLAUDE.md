...
- Per-host delivery checks the suite cannot make: [test/MANUAL.md](test/MANUAL.md)
...
| `test/MANUAL.md` | Manual per-host delivery plan (hooks fire, digest reaches the model, wake) |
